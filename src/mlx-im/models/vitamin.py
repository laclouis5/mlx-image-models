...
class MbConvStages(nn.Module):
    ...
    def __init__(
        ...
        self.pool = StridedConv(
            stride=2, in_chans=cfg.embed_dim[1], embed_dim=cfg.embed_dim[2]
        )
...
default_cfgs = generate_default_cfgs(
    {
        ...
        "vitamin_large_256.datacomp1b_clip": _cfg(
            hf_hub_id="jienengchen/ViTamin-L-256px",
            num_classes=768,
            input_size=(3, 256, 256),
            crop_pct=1.0,
        ),
        "vitamin_large_336.datacomp1b_clip": _cfg(
            hf_hub_id="jienengchen/ViTamin-L-336px",
            num_classes=768,
            input_size=(3, 336, 336),
            crop_pct=1.0,
        ),
        "vitamin_large_384.datacomp1b_clip": _cfg(
            hf_hub_id="jienengchen/ViTamin-L-384px",
            num_classes=768,
        ...
        "vitamin_large2_256.datacomp1b_clip": _cfg(
            hf_hub_id="jienengchen/ViTamin-L2-256px",
            num_classes=1024,
            input_size=(3, 256, 256),
            crop_pct=1.0,
        ),
        "vitamin_large2_336.datacomp1b_clip": _cfg(
            hf_hub_id="jienengchen/ViTamin-L2-336px",
            num_classes=1024,
            input_size=(3, 336, 336),
            crop_pct=1.0,
        ),
        "vitamin_large2_384.datacomp1b_clip": _cfg(
            hf_hub_id="jienengchen/ViTamin-L2-384px",
            num_classes=1024,
            input_size=(3, 384, 384),
            crop_pct=1.0,
        ),
        "vitamin_xlarge_256.datacomp1b_clip": _cfg(
            hf_hub_id="jienengchen/ViTamin-XL-256px",
            num_classes=1152,
            input_size=(3, 256, 256),
            crop_pct=1.0,
        ),
        "vitamin_xlarge_336.datacomp1b_clip": _cfg(
            hf_hub_id="jienengchen/ViTamin-XL-336px",
            num_classes=1152,
            input_size=(3, 336, 336),
            crop_pct=1.0,
        ),
        "vitamin_xlarge_384.datacomp1b_clip": _cfg(
            hf_hub_id="jienengchen/ViTamin-XL-384px",
            num_classes=1152,
            input_size=(3, 384, 384),
            crop_pct=1.0,
        ),
...
def vitamin_small_224(pretrained=False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vitamin(
        "vitamin_small_224", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def vitamin_base_224(pretrained=False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vitamin(
        "vitamin_base_224", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def vitamin_large_224(pretrained=False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vitamin(
        "vitamin_large_224", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def vitamin_large_256(pretrained=False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vitamin(
        "vitamin_large_256", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def vitamin_large_336(pretrained=False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vitamin(
        "vitamin_large_336", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def vitamin_large_384(pretrained=False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vitamin(
        "vitamin_large_384", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def vitamin_large2_224(pretrained=False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vitamin(
        "vitamin_large2_224", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def vitamin_large2_256(pretrained=False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vitamin(
        "vitamin_large2_256", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def vitamin_large2_336(pretrained=False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vitamin(
        "vitamin_large2_336", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def vitamin_large2_384(pretrained=False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vitamin(
        "vitamin_large2_384", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def vitamin_xlarge_384(pretrained=False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vitamin(
        "vitamin_xlarge_384", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
