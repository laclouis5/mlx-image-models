...
class Stem(nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        self.conv1 = nn.Conv2d(in_chs, out_chs // 2, kernel_size=3, stride=2, padding=1)
...
class MlpHead(nn.Module):
    ...
    def __init__(
        ...
        self.fc = (
            nn.Linear(self.num_features, num_classes, bias=bias)
            if num_classes > 0
            else nn.Identity()
        )
...
class MambaOut(nn.Module):
    ...
    def __init__(
        ...
        for i in range(num_stage):
            ...
            self.feature_info += [
                dict(num_chs=prev_dim, reduction=curr_stride, module=f"stages.{i}")
            ]
            cur += depths[i]
...
default_cfgs = generate_default_cfgs(
    {
        ...
        "test_mambaout": _cfg(
            input_size=(3, 160, 160), test_input_size=(3, 192, 192), pool_size=(5, 5)
        ),
    }
)
...
def mambaout_femto(pretrained=False, **kwargs):
    ...
    return _create_mambaout(
        "mambaout_femto", pretrained=pretrained, **dict(model_args, **kwargs)
    )
...
def mambaout_kobe(pretrained=False, **kwargs):
    ...
    return _create_mambaout(
        "mambaout_kobe", pretrained=pretrained, **dict(model_args, **kwargs)
    )
...
def mambaout_tiny(pretrained=False, **kwargs):
    ...
    return _create_mambaout(
        "mambaout_tiny", pretrained=pretrained, **dict(model_args, **kwargs)
    )
...
def mambaout_small(pretrained=False, **kwargs):
    ...
    return _create_mambaout(
        "mambaout_small", pretrained=pretrained, **dict(model_args, **kwargs)
    )
...
def mambaout_base(pretrained=False, **kwargs):
    ...
    return _create_mambaout(
        "mambaout_base", pretrained=pretrained, **dict(model_args, **kwargs)
    )
...
def mambaout_small_rw(pretrained=False, **kwargs):
    ...
    return _create_mambaout(
        "mambaout_small_rw", pretrained=pretrained, **dict(model_args, **kwargs)
    )
...
def mambaout_base_short_rw(pretrained=False, **kwargs):
    ...
    return _create_mambaout(
        "mambaout_base_short_rw", pretrained=pretrained, **dict(model_args, **kwargs)
    )
...
def mambaout_base_tall_rw(pretrained=False, **kwargs):
    ...
    return _create_mambaout(
        "mambaout_base_tall_rw", pretrained=pretrained, **dict(model_args, **kwargs)
    )
...
def mambaout_base_wide_rw(pretrained=False, **kwargs):
    ...
    return _create_mambaout(
        "mambaout_base_wide_rw", pretrained=pretrained, **dict(model_args, **kwargs)
    )
