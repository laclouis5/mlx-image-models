...
default_cfgs = generate_default_cfgs(
    {
        ...
        "convnext_nano.in12k": _cfg(
            hf_hub_id="timm/", crop_pct=0.95, num_classes=11821
        ),
...
def convnext_zepto_rms(pretrained=False, **kwargs) -> ConvNeXt:
    ...
    model = _create_convnext(
        "convnext_zepto_rms", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def convnext_zepto_rms_ols(pretrained=False, **kwargs) -> ConvNeXt:
    ...
    model = _create_convnext(
        "convnext_zepto_rms_ols", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def convnext_atto(pretrained=False, **kwargs) -> ConvNeXt:
    ...
    model = _create_convnext(
        "convnext_atto", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def convnext_atto_ols(pretrained=False, **kwargs) -> ConvNeXt:
    ...
    model = _create_convnext(
        "convnext_atto_ols", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def convnext_atto_rms(pretrained=False, **kwargs) -> ConvNeXt:
    ...
    model = _create_convnext(
        "convnext_atto_rms", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def convnext_femto(pretrained=False, **kwargs) -> ConvNeXt:
    ...
    model = _create_convnext(
        "convnext_femto", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def convnext_femto_ols(pretrained=False, **kwargs) -> ConvNeXt:
    ...
    model = _create_convnext(
        "convnext_femto_ols", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def convnext_pico(pretrained=False, **kwargs) -> ConvNeXt:
    ...
    model = _create_convnext(
        "convnext_pico", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def convnext_pico_ols(pretrained=False, **kwargs) -> ConvNeXt:
    ...
    model = _create_convnext(
        "convnext_pico_ols", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def convnext_nano(pretrained=False, **kwargs) -> ConvNeXt:
    ...
    model = _create_convnext(
        "convnext_nano", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def convnext_nano_ols(pretrained=False, **kwargs) -> ConvNeXt:
    ...
    model = _create_convnext(
        "convnext_nano_ols", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def convnext_tiny_hnf(pretrained=False, **kwargs) -> ConvNeXt:
    ...
    model = _create_convnext(
        "convnext_tiny_hnf", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def convnext_tiny(pretrained=False, **kwargs) -> ConvNeXt:
    ...
    model = _create_convnext(
        "convnext_tiny", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def convnext_small(pretrained=False, **kwargs) -> ConvNeXt:
    ...
    model = _create_convnext(
        "convnext_small", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def convnext_base(pretrained=False, **kwargs) -> ConvNeXt:
    ...
    model = _create_convnext(
        "convnext_base", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def convnext_large_mlp(pretrained=False, **kwargs) -> ConvNeXt:
    model_args = dict(
        depths=[3, 3, 27, 3], dims=[192, 384, 768, 1536], head_hidden_size=1536
    )
    model = _create_convnext(
        "convnext_large_mlp", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def convnext_xlarge(pretrained=False, **kwargs) -> ConvNeXt:
    ...
    model = _create_convnext(
        "convnext_xlarge", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def convnext_xxlarge(pretrained=False, **kwargs) -> ConvNeXt:
    ...
    model = _create_convnext(
        "convnext_xxlarge", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def convnextv2_atto(pretrained=False, **kwargs) -> ConvNeXt:
    ...
    model = _create_convnext(
        "convnextv2_atto", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def convnextv2_femto(pretrained=False, **kwargs) -> ConvNeXt:
    ...
    model = _create_convnext(
        "convnextv2_femto", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def convnextv2_pico(pretrained=False, **kwargs) -> ConvNeXt:
    ...
    model = _create_convnext(
        "convnextv2_pico", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def convnextv2_nano(pretrained=False, **kwargs) -> ConvNeXt:
    ...
    model = _create_convnext(
        "convnextv2_nano", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def convnextv2_tiny(pretrained=False, **kwargs) -> ConvNeXt:
    model_args = dict(
        depths=(3, 3, 9, 3), dims=(96, 192, 384, 768), use_grn=True, ls_init_value=None
    )
    model = _create_convnext(
        "convnextv2_tiny", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def convnextv2_small(pretrained=False, **kwargs) -> ConvNeXt:
    model_args = dict(
        depths=[3, 3, 27, 3], dims=[96, 192, 384, 768], use_grn=True, ls_init_value=None
    )
    model = _create_convnext(
        "convnextv2_small", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def convnextv2_base(pretrained=False, **kwargs) -> ConvNeXt:
    ...
    model = _create_convnext(
        "convnextv2_base", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def convnextv2_large(pretrained=False, **kwargs) -> ConvNeXt:
    ...
    model = _create_convnext(
        "convnextv2_large", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def convnextv2_huge(pretrained=False, **kwargs) -> ConvNeXt:
    ...
    model = _create_convnext(
        "convnextv2_huge", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def test_convnext(pretrained=False, **kwargs) -> ConvNeXt:
    ...
    model = _create_convnext(
        "test_convnext", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def test_convnext2(pretrained=False, **kwargs) -> ConvNeXt:
    ...
    model = _create_convnext(
        "test_convnext2", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def test_convnext3(pretrained=False, **kwargs) -> ConvNeXt:
    ...
    model = _create_convnext(
        "test_convnext3", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
