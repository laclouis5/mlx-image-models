...
def crossvit_tiny_240(pretrained=False, **kwargs) -> CrossVit:
    ...
    model = _create_crossvit(
        variant="crossvit_tiny_240", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def crossvit_base_240(pretrained=False, **kwargs) -> CrossVit:
    ...
    model = _create_crossvit(
        variant="crossvit_base_240", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def crossvit_9_240(pretrained=False, **kwargs) -> CrossVit:
    ...
    model = _create_crossvit(
        variant="crossvit_9_240", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def crossvit_15_240(pretrained=False, **kwargs) -> CrossVit:
    ...
    model = _create_crossvit(
        variant="crossvit_15_240", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def crossvit_18_240(pretrained=False, **kwargs) -> CrossVit:
    ...
    model = _create_crossvit(
        variant="crossvit_18_240", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def crossvit_15_dagger_240(pretrained=False, **kwargs) -> CrossVit:
    ...
    model = _create_crossvit(
        variant="crossvit_15_dagger_240",
        pretrained=pretrained,
        **dict(model_args, **kwargs),
    )
    return model
...
def crossvit_15_dagger_408(pretrained=False, **kwargs) -> CrossVit:
    ...
    model = _create_crossvit(
        variant="crossvit_15_dagger_408",
        pretrained=pretrained,
        **dict(model_args, **kwargs),
    )
    return model
...
def crossvit_18_dagger_240(pretrained=False, **kwargs) -> CrossVit:
    ...
    model = _create_crossvit(
        variant="crossvit_18_dagger_240",
        pretrained=pretrained,
        **dict(model_args, **kwargs),
    )
    return model
...
def crossvit_18_dagger_408(pretrained=False, **kwargs) -> CrossVit:
    ...
    model = _create_crossvit(
        variant="crossvit_18_dagger_408",
        pretrained=pretrained,
        **dict(model_args, **kwargs),
    )
    return model
