...
class PreActBasic(nn.Module):
    ...
    def __init__(
        ...
        self.conv1 = conv_layer(
            in_chs, mid_chs, 3, stride=stride, dilation=first_dilation, groups=groups
        )
...
def resnetv2_18(pretrained=False, **kwargs) -> ResNetV2:
    ...
    return _create_resnetv2(
        "resnetv2_18", pretrained=pretrained, **dict(model_args, **kwargs)
    )
...
def resnetv2_18d(pretrained=False, **kwargs) -> ResNetV2:
    ...
    return _create_resnetv2(
        "resnetv2_18d", pretrained=pretrained, **dict(model_args, **kwargs)
    )
...
def resnetv2_34(pretrained=False, **kwargs) -> ResNetV2:
    ...
    return _create_resnetv2(
        "resnetv2_34", pretrained=pretrained, **dict(model_args, **kwargs)
    )
...
def resnetv2_34d(pretrained=False, **kwargs) -> ResNetV2:
    ...
    return _create_resnetv2(
        "resnetv2_34d", pretrained=pretrained, **dict(model_args, **kwargs)
    )
...
def resnetv2_50(pretrained=False, **kwargs) -> ResNetV2:
    ...
    return _create_resnetv2(
        "resnetv2_50", pretrained=pretrained, **dict(model_args, **kwargs)
    )
...
def resnetv2_50d(pretrained=False, **kwargs) -> ResNetV2:
    ...
    return _create_resnetv2(
        "resnetv2_50d", pretrained=pretrained, **dict(model_args, **kwargs)
    )
...
def resnetv2_50t(pretrained=False, **kwargs) -> ResNetV2:
    ...
    return _create_resnetv2(
        "resnetv2_50t", pretrained=pretrained, **dict(model_args, **kwargs)
    )
...
def resnetv2_101(pretrained=False, **kwargs) -> ResNetV2:
    ...
    return _create_resnetv2(
        "resnetv2_101", pretrained=pretrained, **dict(model_args, **kwargs)
    )
...
def resnetv2_101d(pretrained=False, **kwargs) -> ResNetV2:
    ...
    return _create_resnetv2(
        "resnetv2_101d", pretrained=pretrained, **dict(model_args, **kwargs)
    )
...
def resnetv2_152(pretrained=False, **kwargs) -> ResNetV2:
    ...
    return _create_resnetv2(
        "resnetv2_152", pretrained=pretrained, **dict(model_args, **kwargs)
    )
...
def resnetv2_152d(pretrained=False, **kwargs) -> ResNetV2:
    ...
    return _create_resnetv2(
        "resnetv2_152d", pretrained=pretrained, **dict(model_args, **kwargs)
    )
...
def resnetv2_50d_gn(pretrained=False, **kwargs) -> ResNetV2:
    ...
    return _create_resnetv2(
        "resnetv2_50d_gn", pretrained=pretrained, **dict(model_args, **kwargs)
    )
...
def resnetv2_50d_evos(pretrained=False, **kwargs) -> ResNetV2:
    ...
    return _create_resnetv2(
        "resnetv2_50d_evos", pretrained=pretrained, **dict(model_args, **kwargs)
    )
...
def resnetv2_50d_frn(pretrained=False, **kwargs) -> ResNetV2:
    ...
    return _create_resnetv2(
        "resnetv2_50d_frn", pretrained=pretrained, **dict(model_args, **kwargs)
    )
