...
class EfficientNetBuilder:
    ...
    def _make_block(self, ba, block_idx, block_count):
        ...
        if bt == "ir":
            ...
            _log_info_if(
                "  UniversalInvertedResidual {}, Args: {}".format(block_idx, str(ba)),
                self.verbose,
            )
            ...
            _log_info_if(
                "  MobileMultiQueryAttention {}, Args: {}".format(block_idx, str(ba)),
                self.verbose,
            )
            ...
            _log_info_if(
                "  MobileMultiHeadAttention {}, Args: {}".format(block_idx, str(ba)),
                self.verbose,
            )
            block = MobileAttention(
                **ba, layer_scale_init_value=self.layer_scale_init_value
    ...
    def __call__(self, in_chs, model_block_args):
        ...
        if model_block_args[0][0]["stride"] > 1:
            ...
            feature_info = dict(
                module="bn1", num_chs=in_chs, stage=0, reduction=current_stride
            )
