...
def checkpoint_filter_fn(
    ...
    return _filter_fn(
        state_dict, model, interpolation=interpolation, antialias=antialias
    )


def _create_vision_transformer_hybrid(
    variant, backbone, embed_args=None, pretrained=False, **kwargs
):
